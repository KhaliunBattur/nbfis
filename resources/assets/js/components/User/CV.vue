                        ...
                        <div class="box-body">
                            <div class="cv">
                                ...
                                <table class="cv-table cv-lg cv-top-border-none" >
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 70%;">
                                            ...
                                            <span>Б.Түрээсийн байр</span>
                                            <span>В.Ипотек</span>
                                            <span>Г.Хамаатан</span>
                                            <span>Д.Бусад</span>
                                        </td>
                                    </tr>
                                    </tbody>
                                ...
                                <table class="cv-table cv-md">
                                    <tbody>
                                    <tr>
                                        <td style="width: 65%;">Орлого, зардал:</td>
                                        <td style="width: 40%;">Сарын дүн</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 60%;">Сарын орлого:</td>
                                        <td style="width: 40%;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 60%;">Ажилчдын цалингын зардал:</td>
                                        <td style="width: 40%;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 50%;">Оффисын түрээсийн зардал:</td>
                                        <td style="width: 50%;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 50%;">Бараа материал татан авалтын зардал:</td>
                                        <td style="width: 50%;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 50%;">Байгууллагын бензиний зардал:</td>
                                        <td style="width: 50%;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 50%;">Тог цахилгаан, ус, утас, бусад зардал нийт:</td>
                                        <td style="width: 50%;">&nbsp;</td>
                                    </tr>
                                    </tbody>
                                </table>
                                <table class="cv-table cv-md cv-md-margin-left">
                                    ...
                                    <tr>
                                        <td style="width: 30%;">Банкны хадгаламж</td>
                                        <td style="width: 20%;">&nbsp;</td>
                                        <td style="width: 30%;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 30%;">Байр</td>
                                        <td style="width: 20%;">&nbsp;</td>
                                        <td style="width: 30%;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 30%;">Амины орон сууц, газар</td>
                                        <td style="width: 20%;">&nbsp;</td>
                                        <td style="width: 30%;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 30%;">Авто машин</td>
                                        <td style="width: 20%;">&nbsp;</td>
                                        <td style="width: 30%;">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 30%;">Газар</td>
                                        <td style="width: 20%;">&nbsp;</td>
                                        <td style="width: 30%;">&nbsp;</td>
                                    </tr>
                                    <tr>
