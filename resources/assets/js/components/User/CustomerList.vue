            ...
            <div class="col-lg-12">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <router-link to="/customers/create" class="btn btn-sm btn-default">Шинээр нэмэх</router-link>
                        </div>
                    </div>
                    <div class="box-body">
                        <div v-bind:class="loading ? 'table-responsive table-sm loading' : 'table-responsive table-sm'">
                            ...
                            <div class="pull-right">
                                <div class="radio-inline">
                                    <input type="radio" v-model="query.user_type" value="allCustomer" /> Бүгд
                                </div>
                                <div class="radio-inline">
                                    <input type="radio" v-model="query.user_type" value="organization" /> Байгууллага
                                </div>
                                <div class="radio-inline">
                                    <input type="radio" v-model="query.user_type" value="customer" /> Хувь хүн
                                </div>
                            </div>
