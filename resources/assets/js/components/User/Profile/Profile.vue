            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img v-if="user.image !== null" class="profile-user-img img-responsive img-circle" :src="user.image" alt="User profile picture">

                        <h3 class="profile-username text-center">{{ user.first_name }} {{ user.name }}</h3>

                        <p class="text-muted text-center" v-if="user.roles.length > 0"><span class="text" v-for="role in user.roles">{{ role.display_name + ', ' }}</span></p>
                    ...
                    <div class="tab-pane" id="family">
                        ...
                        <div class="post">
                            <div class="user-block">
                                <img class="img-circle img-bordered-sm" src="pages/img/user1-128x128.jpg" alt="user image">
                                <span class="username">
                        ...
                        <div class="post clearfix">
                            <div class="user-block">
                                <img class="img-circle img-bordered-sm" src="pages/img/user7-128x128.jpg" alt="User Image">
                                <span class="username">
                          <a href="#">Sarah Ross</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                        ...
                        <div class="post">
                            <div class="user-block">
                                <img class="img-circle img-bordered-sm" src="pages/img/user6-128x128.jpg" alt="User Image">
                                <span class="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                            ...
                            <div class="row margin-bottom">
                                <div class="col-sm-6">
                                    <img class="img-responsive" src="pages/img/photo1.png" alt="Photo">
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-6">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <img class="img-responsive" src="pages/img/photo2.png" alt="Photo">
                                            <br>
                                            <img class="img-responsive" src="pages/img/photo3.jpg" alt="Photo">
                                        </div>
                                        <!-- /.col -->
                                        <div class="col-sm-6">
                                            <img class="img-responsive" src="pages/img/photo4.jpg" alt="Photo">
                                            <br>
                                            <img class="img-responsive" src="pages/img/photo1.png" alt="Photo">
                                        </div>
                                        <!-- /.col -->
