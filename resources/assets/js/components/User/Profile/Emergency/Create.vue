            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" maxlength="255" type="number" v-model="emergency.budged" name="budged" v-validate="'required|max:255'" :class="{'form-control': true, 'is-danger': errors.has('budged') }"/>
