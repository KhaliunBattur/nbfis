<template>
    <div class="modal fade" id="form_00012" tabindex="-1" role="dialog" aria-labelledby="form_00012ModalLabel" v-modal v-on:showModal="init()" v-on:hideModal="hiddenModal()">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="general_transactionModalLabel">Ажил гүйлгээ шинээр бүртгэх (Мөнгөн хөрөнгө харилцах)</h4>
                </div>
                    ...
                    <div class="table-responsive with-chosen">
                        ...
                        <table class="table table-bordered property-table" style="font-size: 12px !important">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <label class="control-label">Харилцахын</label>
                                        <br />
                                        <div class="radio-inline">
                                            <input name="type" type="radio" v-model="transaction.type" value="debit" checked="checked"> Орлого
                                        </div>
                                        <div class="radio-inline">
                                            <input name="type" type="radio" v-model="transaction.type" value="credit"> Зарлага
                                        </div>
                                    </div>
                                </td>
                            </tr>
    ...
    export default {
        ...
        methods: {
            ...
            init()
            {
                ...
                axios.get('/api/account/list?code=00012').then(response => {
