<template>
    <div class="modal fade" id="form_00011" tabindex="-1" role="dialog" aria-labelledby="form_00011ModalLabel" v-modal v-on:showModal="init()" v-on:hideModal="hiddenModal()">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="general_transactionModalLabel">Ажил гүйлгээ шинээр бүртгэх (Мөнгөн хөрөнгө касс)</h4>
                </div>
                    ...
                    <div class="table-responsive with-chosen">
                        ...
                        <table class="table table-bordered property-table" style="font-size: 12px !important">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <label class="control-label">Кассын</label>
                                        <br />
    ...
    export default {
        ...
        methods: {
            ...
            init()
            {
                ...
                axios.get('/api/account/list?code=00011').then(response => {
