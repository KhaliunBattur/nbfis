<template>
    <div class="modal fade" id="form_00001" tabindex="-1" role="dialog" aria-labelledby="form_00001ModalLabel" v-modal v-on:showModal="init()" v-on:hideModal="hiddenModal()">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="general_transactionModalLabel">Ажил гүйлгээ шинээр бүртгэх (Мөнгөн хөрөнгө)</h4>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            init()
            {
                ...
                axios.get('/api/account/list?code=00001').then(response => {
